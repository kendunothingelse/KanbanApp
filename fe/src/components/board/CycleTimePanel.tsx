    ...
    return (
        <Card sx={{
            ...
            <Typography variant="subtitle1" fontWeight={700} mb={0.5} color="text.primary">
                {labels.cycleTime} (Số ngày để xong 1 việc)
            </Typography>
            <Typography variant="body2" color="text.secondary" mb={2}>
                Mỗi cột là một công việc đã hoàn thành. Cột cao hơn nghĩa là mất nhiều ngày hơn.
            </Typography>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={data} margin={{top: 10, right: 30, left: 0, bottom: 50}}>
                            ...
                            <Bar dataKey="days" name="Số ngày" fill={palette.primary.main} radius={[4, 4, 0, 0]}
                                 barSize={30}/>
                            <ReferenceLine y={avgCycle} stroke={palette.accent.main} strokeDasharray="5 5"
                                           strokeWidth={2} label={{
                                value: "TB",
